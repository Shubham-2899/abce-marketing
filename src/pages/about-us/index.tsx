  ...
  return (
    <Box
      sx={{
        bgcolor: "whitesmoke",
        color: " #777",
        padding: { xs: "10% 12%", sm: "10% 15%", md: "5% 20%" }, // { xs: "10% 12%", sm: "10% 15%", md: "10% 20%" },
        textAlign: "center",
        fontSize: "16px",
      }}
    >
      ...
      <p style={{ textAlign: "justify" }}>
        Our platform is designed to be easy to use and comes with a variety of
        features that make it easy for businesses to create professional-looking
        emails and newsletters. We offer a variety of templates that can be
        customized to fit your brand and style. Our platform also includes
        advanced features like A/B testing, automation, and analytics to help
        you get the most out of your email campaigns.
      </p>
      ...
      <p style={{ textAlign: "justify" }}>
        ...
        customers and grow your business. Our platform is designed to be easy to
        use and comes with a variety of features that make it easy for
        businesses to create professional-looking emails and newsletters. We are
      ...
      <p style={{ textAlign: "justify" }}>
        Our team of experts is dedicated to helping businesses succeed with
        email marketing. We have years of experience in the industry and are
        committed to providing the best tools and support to help businesses
